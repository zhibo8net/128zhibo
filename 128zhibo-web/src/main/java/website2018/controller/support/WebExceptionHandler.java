...
@ControllerAdvice(basePackages="website2018.controller")
public class WebExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<ErrorResult> handleServiceException(ServiceException ex, HttpServletRequest request) {
	    ...
	    logErrorWithoutStacktrace(ex, request);
    ...
    public void logErrorWithoutStacktrace(Exception ex, HttpServletRequest request) {
        Map<String, String> map = Maps.newHashMap();
        map.put("message", ex.getMessage());
